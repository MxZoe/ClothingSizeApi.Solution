...
//id	brand	clothing type	gender	letter size	min number size	max number size	min hip measurement	max hip measurement	min waist measurement	max waist measurement	min bust measurement	max bust measurement	